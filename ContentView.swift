...
struct MainView: View {
    @State private var gameScore: String = "Bye Week"
    @State private var nextGame: String = "Next Game: Buccaneers at Tampa"
    ...
    private func handleScenePhaseChange(_ newPhase: ScenePhase) {
        switch newPhase {
        case .active:
            print("App is active. Resume activities.")
        case .inactive:
            print("App is inactive. Pause activities.")
        case .background:
            print("App is in the background. Save data.")
            saveAppData()
        @unknown default:
            print("Unknown state")
        }

        // Append the previous state to the list
        previousStates.append(newPhase)
    }
